...
const printDanhSachTiec = (data, options = {}) => {
  try {
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th class="ma-col">Số phiếu</th>
                  <th class="tenchure-col">Tên chú rể</th>
                  <th class="tencodau-col">Tên cô dâu</th>
                  <th class="sanh-col">Sảnh</th>
                  <th class="soban-col">Số bàn</th>
                  <th class="ngay-col">Ngày</th>
                  <th class="gio-col">Giờ</th>
                  <th class="trangthai-col">Trạng thái</th>
                </tr>
              </thead>
              <tbody>
  ${data
        ...
        <tr>
          ...
          <td class="text-center">${item.SoPhieuDatTiec || ''}</td>
          <td class="text-left">${item.TenChuRe || ''}</td>
          <td class="text-left">${item.TenCoDau || ''}</td>
          <td class="text-left">${item.Sanh?.TenSanh || ''}</td>
...
export default printDanhSachTiec;
